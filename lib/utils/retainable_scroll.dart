...
/// Use [retainOffset] to freeze the position at the screen until user will make another scroll action.
...
class RetainableScrollPosition extends ScrollPositionWithSingleContext {
  ...
  bool get shouldRestoreRetainedOffset => _oldMaxScrollExtent != null && _oldPixels != null;
